...
test.beforeEach((t) => {
  ...
  t.context.runner = new ScummVMGameRunner(t.context.fileHandler, t.context.logger, t.context.cli);
});
...
test('Create bin file should create a new executable bin file to run the ScummVM game', (t) => {

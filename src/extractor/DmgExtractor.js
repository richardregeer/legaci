...
class DmgExtractor extends Extractor {
  extract(fullFileName, fullDestination) {
    ...
    // Check if the shell script contains a zip file


    try {
      const command = `p7zip "${fullFileName}" -g -d ${tempDestination}`;
